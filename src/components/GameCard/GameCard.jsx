  ...
  return (
    <Card className="game-card h-100 shadow-sm">
      ...
      <Card.Body className="d-flex flex-column">
        <Card.Title className="game-tittle h6 mb-3">{game.title}</Card.Title>

        <div className="game-details mt-auto">
          <div className="game-detail-item mb-2">
            <Calendar size={14} className="me-2 text-muted" />
            <small className="text-muted">{dateFormatter(game.release_date)}</small>
          </div>

          <div className="game-detail-item mb-2">
            <Person size={14} className="me-2 text-muted" />
            <small className="text-muted">{game.publisher}</small>
          </div>
